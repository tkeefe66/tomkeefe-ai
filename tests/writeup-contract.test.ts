...
const ALLOWED: Record<string, string[]> = {
  // Internal-only tool with no public demo; the live-app CTA is intentionally omitted.
  "b2b-martech-intel": ["cta-links"],
  // Personal tool with no public demo; the live-app CTA is intentionally omitted.
  inventory: ["cta-links"],
  "outdoor-telegram-agent": ["cta-links"],
  "code-coach": ["cta-links"],
};
